...
让我们创建两个整数变量和五个新方法的基础结构，我们需要它们来保存我们将在本章中编写的 Java 代码。这段代码将跟踪游戏板在每次旋转后停留在哪个象限，然后用随机内容处理游戏板方块的“群体”,这是我们在前一章中部分(25 %)开发的。我将使用象限 1(橙色)内容来测试我们在本章中制作的逻辑，因为我还没有创建开发初始代码所需的数百个图像资产(每个游戏棋盘方格六个，或开始时 120 个)。以后只需增加随机数生成器的上限值并更新 populateQuadrant()方法的逻辑，就可以添加更多的资产。我们在这一章要做的将会有几百行代码，所以我们会在这一章做很多编码工作，让游戏随机选择内容让玩家解决。
...
![A336284_1_En_19_Fig1_HTML.jpg](A336284_1_En_19_Fig1_HTML.jpg)
...
![A336284_1_En_19_Fig2_HTML.jpg](A336284_1_En_19_Fig2_HTML.jpg)
...
![A336284_1_En_19_Fig3_HTML.jpg](A336284_1_En_19_Fig3_HTML.jpg)
...
![A336284_1_En_19_Fig4_HTML.jpg](A336284_1_En_19_Fig4_HTML.jpg)
...
![A336284_1_En_19_Fig5_HTML.jpg](A336284_1_En_19_Fig5_HTML.jpg)
...
然后，这些 populateQuadrant()方法将从您的不同内容图像中随机选择每个游戏棋盘方格，我目前有十五个(象限 1 的五个附加游戏棋盘方格中的每一个有三个)。因此，我们将有一个 random.nextInt(3)方法，该方法将从每个方块的三个图像资产中进行选择，设置漫射图像对象以引用选定的数字图像资产，然后设置该游戏棋盘方块的着色器以将该图像对象重新加载到该纹理贴图的内存中。
...
![A336284_1_En_19_Fig6_HTML.jpg](A336284_1_En_19_Fig6_HTML.jpg)
...
![A336284_1_En_19_Fig7_HTML.jpg](A336284_1_En_19_Fig7_HTML.jpg)
...
![A336284_1_En_19_Fig8_HTML.jpg](A336284_1_En_19_Fig8_HTML.jpg)
...
![A336284_1_En_19_Fig9_HTML.jpg](A336284_1_En_19_Fig9_HTML.jpg)
...
![A336284_1_En_19_Fig10_HTML.jpg](A336284_1_En_19_Fig10_HTML.jpg)
...
![A336284_1_En_19_Fig11_HTML.jpg](A336284_1_En_19_Fig11_HTML.jpg)
...
![A336284_1_En_19_Fig12_HTML.jpg](A336284_1_En_19_Fig12_HTML.jpg)
...
![A336284_1_En_19_Fig13_HTML.jpg](A336284_1_En_19_Fig13_HTML.jpg)
...
![A336284_1_En_19_Fig14_HTML.jpg](A336284_1_En_19_Fig14_HTML.jpg)
...
![A336284_1_En_19_Fig15_HTML.jpg](A336284_1_En_19_Fig15_HTML.jpg)
...
![A336284_1_En_19_Fig16_HTML.jpg](A336284_1_En_19_Fig16_HTML.jpg)
...
![A336284_1_En_19_Fig17_HTML.jpg](A336284_1_En_19_Fig17_HTML.jpg)
...
![A336284_1_En_19_Fig18_HTML.jpg](A336284_1_En_19_Fig18_HTML.jpg)
...
![A336284_1_En_19_Fig19_HTML.jpg](A336284_1_En_19_Fig19_HTML.jpg)
...
在第十九章中，我们学习了如何实现游戏棋盘方块内容的随机选择，同时实现更多的游戏代码，这些代码可以智能地跟踪游戏棋盘的旋转，并使用 Java 数学运算符和简单而强大的编程算法和结构来确定象限在每次旋转中的位置。我们在角度偏移评估的顺序和这些指向的 populateQuadrant()方法中调试了几个问题，并且我们找到了一种将图像加载到内存中的方法，而无需一次在系统内存中声明二十多个游戏板漫反射纹理图像。这种方法允许我们向游戏应用程序添加数百个内容图像，而不会产生内存不足的错误。
