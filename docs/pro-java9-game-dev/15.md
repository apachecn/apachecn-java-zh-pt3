...
我们将在本章的下一节使用 GIMP 创建这些漫射纹理贴图数字图像资产。打开 createMaterials()方法体，并添加相应的 Shader21 到 Shader25 对象实例化和配置语句，这些语句“连接着色器”以引用漫反射纹理贴图图像对象资源。

如果您愿意，也可以使用复制和粘贴来完成此操作，就像您对漫反射纹理贴图图像对象所做的那样。创建新着色器并将其引用到漫反射纹理贴图图像对象资产的 Java 代码应类似于以下 Java 代码语句块，在图 [15-3](#Fig3) 中高亮显示:
...
![A336284_1_En_15_Fig5_HTML.jpg](A336284_1_En_15_Fig5_HTML.jpg)
...
![A336284_1_En_15_Fig13_HTML.jpg](A336284_1_En_15_Fig13_HTML.jpg)
...
![A336284_1_En_15_Fig16_HTML.jpg](A336284_1_En_15_Fig16_HTML.jpg)
