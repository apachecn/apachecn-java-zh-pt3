...
![A978-1-4842-1836-5_3_Figbb_HTML.gif](A978-1-4842-1836-5_3_Figbb_HTML.gif)一个函数式接口的声明产生了一个可以和 lambda 表达式一起使用的“函数式接口类型”。此外，在 Java 8 中引入的`java.util.function`和`java.util.stream`包中广泛使用了函数式接口。鉴于这个主题的重要性，你可以预期在你的 OCPJP 8 考试中会有许多与功能接口相关的问题。
